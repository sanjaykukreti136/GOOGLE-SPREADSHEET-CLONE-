...
// // //////   ABCD COLOUMN MOVE, 1 2 3 4 ROW MOVE
...
// // ///// ADD CELLS 100 ROWS AND 26 COLOUMS 
// // for (let i = 1; i <= 100; i++) {
...
// //             for (let j = 0; j < currDownstream.length; j++) {
...
// //             ////////////  FORMULA BAR VALUE CHANGE ACCORDING TO SELECTED CELL
// //             let currCellAddress = e.currentTarget.getAttribute("data-address")
